...
Сервис для автоматической обработки портретных фотографий с возможностью удаления фона, кадрирования и улучшения качества. Предоставляет SOAP API и веб-интерфейс для ручной загрузки.
